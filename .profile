...
export PAGER="bat --paging=always --style='changes' --wrap=auto"
...
export PATH="/home/zaater/.local/bin:$GOPATH/bin:$PATH"
export WIFITUI_THEME="$XDG_CONFIG_HOME/wifitui/theme.toml"
